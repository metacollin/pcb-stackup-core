...
module.exports = function (element, id, side, layers, drills, outlines, useOutline) {
  ...
  defs.push(mechMask(element, mechMaskId, box, drills, outlineIds))
  ...
  layerProps.outlineIds.forEach(function(outLayerId) {
    if (outLayerId != primaryOutLayerId){
        layer.push(useLayer(element, outLayerId, classPrefix + 'sp'))
    }
